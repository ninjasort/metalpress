...
exports.default = function () {
  ...
  if (options.shortcodes) {
    m.use((0, _metalsmithFlexibleShortcodes2.default)(options.shortcodes));
  }
  ...
  // --------------------------------------------------------------------------
  if (options.firebase) {
    m.use((0, _metalsmithFirebase2.default)(options.firebase));
    m.use((0, _metalsmithFirebase.transform)(options.firebase));
  }
  ...
  if (m.metadata().production) {
    m.use((0, _metalsmithDrafts2.default)());
  }
...
var _metalsmithFlexibleShortcodes = require('metalsmith-flexible-shortcodes');

var _metalsmithFlexibleShortcodes2 = _interopRequireDefault(_metalsmithFlexibleShortcodes);
...
var _metalsmithFirebase = require('metalsmith-firebase');

var _metalsmithFirebase2 = _interopRequireDefault(_metalsmithFirebase);
